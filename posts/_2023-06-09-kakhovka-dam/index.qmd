...
The function below will render a view of our map with a water level rise of zero though ten meters. Again, this doesn't assume the water rose ten meters, only that it reached ten meters above sea level. That means land at an altitude of nine meters will be one meter underwater for a ten meter water rise. We save each a single image for each meter of water rise.
...
Now that we have saved 11 still frames we can animate them into a short GIF file with almost no work at all.
...
While we don't know what the maximum water height was or if all of the specific areas shown above got inundated but we know many did and this clearly shows the vulnerable areas.
